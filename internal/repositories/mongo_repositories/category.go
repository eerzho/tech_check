...
func NewCategory(db *mongo.Database) *Category {
	return &Category{
		maxListCount: 200,
		collection:   db.Collection(constants.TableCategories.String()),
	}
}
...
func (c *Category) Create(ctx context.Context, category *models.Category) error {
...
func (c *Category) Update(ctx context.Context, category *models.Category) error {
